...
button1 = KeyboardButton("Стандарт ✈️")
...
time_of_deliveo = ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True).add(
    KeyboardButton("Привезти в течение 60 минут 6️⃣0️⃣")
).add(
    KeyboardButton("Привезти в течение 120 минут 1️⃣2️⃣0️⃣")
).add(
    KeyboardButton("Привезти в течение 180 минут 1️⃣8️⃣0️⃣")
)

#кнопки внутри бота
inline_button1 = InlineKeyboardButton("Стандарт ✈️", callback_data='button1')
...
inline_button12 = InlineKeyboardButton("Привезти в течение 60 минут 6️⃣0️⃣", callback_data='button12')
inline_button13 = InlineKeyboardButton("Привезти в течение 120 минут 1️⃣2️⃣0️⃣", callback_data='button13')
inline_button14 = InlineKeyboardButton("Привезти в течение 180 минут 1️⃣8️⃣0️⃣", callback_data='button14')
